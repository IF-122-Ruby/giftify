...
RSpec.describe "Account::Organization", type: :request do
  ...
  describe "GET #edit" do
    it "returns http success if signed in as admin" do
      get edit_account_organization_path(admin)
  ...
  describe "PATCH #update" do
    ...
    it "organization was updated with valid params" do
      patch account_organization_path(organization), params: { organization: organization_params }
