...
RSpec.describe Account::UsersController, type: :request do
  ...
  context 'signed in as superadmin' do
    before do
      sign_in superadmin
    end
    ...
    describe 'GET #show' do
      it 'returns http success status' do
        get account_user_path(superadmin)
    ...
    describe 'GET #edit' do
      it 'renders edit template' do
        get edit_account_user_path(superadmin)
    ...
    describe 'PATCH #update' do
      ...
      it 'shound update user (in this case admin)' do
        patch account_user_path(superadmin), params: { user: user_update_params }
